...
export type MarketTypeWhereInput = {
  ...
  scalar_containsInsensitive?: InputMaybe<Scalars['String']>
  ...
  scalar_not_containsInsensitive?: InputMaybe<Scalars['String']>
...
export type FullAccountBalanceFragment = {
  __typename?: 'AccountBalance'
  id: string
  assetId: string
  balance: any
...
export type HistoricalAccountBalancesQuery = {
  __typename?: 'Query'
...
export type FullHistoricalAccountBalanceFragment = {
  __typename?: 'HistoricalAccountBalance'
  id: string
  assetId: string
  accountId: string
...
export type HistoricalAssetsQuery = {
  __typename?: 'Query'
...
export type FullHistoricalAssetsFragment = {
  __typename?: 'HistoricalAsset'
  accountId?: string | null
  assetId: string
  blockNumber: number
...
export type MarketsQuery = {
  ...
  markets: Array<{
    ...
    poolId?: number | null
    marketType: { __typename?: 'MarketType'; categorical?: string | null; scalar?: string | null }
    period: { __typename?: 'MarketPeriod'; block?: string | null; timestamp?: string | null }
    report?: {
      __typename?: 'MarketReport'
      at?: number | null
      by?: string | null
      outcome: { __typename?: 'OutcomeReport'; categorical?: number | null; scalar?: any | null }
    } | null
    disputeMechanism: {
      __typename?: 'MarketDisputeMechanism'
...
export type FullMarketFragment = {
  __typename?: 'Market'
  marketId: number
  description?: string | null
  end: any
...
export type PoolsQuery = {
  ...
  pools: Array<{
    ...
    volume: any
    ztgQty: any
    weights: Array<{ __typename?: 'Weight'; assetId: string; len: any } | null>
  }>
}
...
export const HistoricalAccountBalancesDocument = gql`
  query historicalAccountBalances(
    ...
    historicalAccountBalances(where: $where, orderBy: $order, offset: $offset, limit: $limit) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    accountBalances(
      variables?: AccountBalancesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<AccountBalancesQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<AccountBalancesQuery>(AccountBalancesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'accountBalances',
    ...
    historicalAccountBalances(
      variables?: HistoricalAccountBalancesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<HistoricalAccountBalancesQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<HistoricalAccountBalancesQuery>(HistoricalAccountBalancesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'historicalAccountBalances',
    ...
    historicalAssets(
      variables?: HistoricalAssetsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<HistoricalAssetsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<HistoricalAssetsQuery>(HistoricalAssetsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'historicalAssets',
    ...
    pingQuery(
      variables?: PingQueryQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<PingQueryQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PingQueryQuery>(PingQueryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'pingQuery',
    ...
    pools(variables?: PoolsQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<PoolsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PoolsQuery>(PoolsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        'pools',
        'query',
      )
    },
