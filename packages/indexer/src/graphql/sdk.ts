...
export type HistoricalAccountBalancesQueryVariables = Exact<{
  where?: InputMaybe<HistoricalAccountBalanceWhereInput>
  order?: InputMaybe<
    Array<HistoricalAccountBalanceOrderByInput> | HistoricalAccountBalanceOrderByInput
  >
  offset?: InputMaybe<Scalars['Int']>
  limit?: InputMaybe<Scalars['Int']>
}>
...
export type MarketStatusCountQuery = {
  __typename?: 'Query'
...
export function getSdk(
  ...
  return {
    ...
    historicalAccountBalances(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<HistoricalAccountBalancesQuery>(
    ...
    marketStatusCount(
      variables: MarketStatusCountQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<MarketStatusCountQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<MarketStatusCountQuery>(MarketStatusCountDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'marketStatusCount',
