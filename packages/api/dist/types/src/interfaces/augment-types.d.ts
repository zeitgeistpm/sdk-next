...
import type {
  ...
  SerdeWrapper,
  VestingBlockNumber,
} from '@zeitgeistpm/types/interfaces/index'
...
import type {
  ...
  Report,
  ScoringRule,
} from '@zeitgeistpm/types/interfaces/predictionMarkets'
import type {
  EmaConfig,
  EmaMarketVolume,
  FeeSigmoid,
  ...
  Timespan,
  UnixTimestamp,
} from '@zeitgeistpm/types/interfaces/rikkido'
import type {
  ...
  SubsidyUntil,
  SwapEvent,
} from '@zeitgeistpm/types/interfaces/swaps'
