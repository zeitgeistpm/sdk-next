...
[Home](./index.md) &gt; [@zeitgeistpm/sdk](./sdk.md) &gt; [getAssetWeight](./sdk.getassetweight.md)

## getAssetWeight variable
...
```typescript
getAssetWeight: <C extends Context<MS>, MS extends MetadataStorage<{
    __meta: "markets";
    slug: string;
    description: string;
    question: string;
