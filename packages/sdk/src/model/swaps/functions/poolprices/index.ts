 ...
 */
export const poolPrices = async <C extends Context<M>, M extends TaggedMetadata = Metadata>(
  context: C,
 ...
 * @returns Promise<PoolPrices>
 */
const rpc = async <M extends TaggedMetadata = Metadata>(
  ctx: RpcContext<M>,
  query: PoolPricesQuery,
): Promise<PoolPrices> => {
