...
> = C extends IndexerContext ? FullMarketList : AugmentedRpcMarketList<M>
 ...
 */
export type AugmentedRpcMarketList<M extends TaggedMetadata = Metadata> = {
  items: RpcMarket<RpcContext<M>, M>[]
}
